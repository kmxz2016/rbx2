...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rbx2_ar_tags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kmxz/catkin_ws/install/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
